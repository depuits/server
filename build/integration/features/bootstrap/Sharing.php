...
trait Sharing {
	...
	public function enableSharingLegacySyncValidation(): void {
		...
		$this->runOcc(['config:system:set', '--type=boolean', '--value=true', 'unified_sharing.validation.enable']);
	}
	...
	public function disableSharingLegacySyncValidation(): void {
		...
		$this->runOcc(['config:system:delete', 'unified_sharing.validation.enable']);
	}
